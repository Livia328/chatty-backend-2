...
type IBaseJobData = IAuthJob | IEmailJob | IPostJobData | IReactionJob | ICommentJob | IBlockedUserJobData | INotificationJobData | IFileImageDocument | IChatJobData | IMessageData;
